...
static int owl_clkevt_shutdown(struct clock_event_device *clk)
{
...
static int owl_clkevt_resume(struct clock_event_device *clk)
{
...
static int owl_clkevt_set_oneshot(struct clock_event_device *clk)
{
	writel(0x0, owl_timer_base + T1_CTL);
...
static struct clock_event_device owl_clockevent = {
	...
	.set_state_oneshot      = owl_clkevt_set_oneshot,
